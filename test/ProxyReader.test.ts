...
describe('ProxyReader', () => {
  ...
  describe('IRegistryReader', () => {
    it('should support IRegistryReader interface', async () => {
      ...
      */
      expect(await proxyReader.supportsInterface('0x93352e54')).to.be.equal(true);
    });
    ...
    describe('childIdOf', () => {
      it('should return childIdOf of .wallet domain', async () => {
        const proxyResult = await proxyReader.childIdOf(TLD.WALLET, 'test');
      ...
      it('should return childIdOf of .crypto domain', async () => {
        const proxyResult = await proxyReader.childIdOf(TLD.CRYPTO, 'test');
  ...
  describe('IRecordReader', () => {
    it('should support IRecordReader interface', async () => {
       ...
       */
      expect(await proxyReader.supportsInterface('0xdf4c495e')).to.be.equal(true);
    });
  ...
  describe('IDataReader', () => {
    it('should support IDataReader interface', async () => {
       ...
       */
      expect(await proxyReader.supportsInterface('0x46d43268')).to.be.equal(true);
    });
