...
import { Resolver } from '../typechain-types/dot-crypto/contracts';
...
import { Resolver__factory } from '../typechain-types/factories/dot-crypto/contracts';
import { SignerWithAddress } from '@nomiclabs/hardhat-ethers/signers';

describe('MintingManager (proxy)', () => {
  let unsRegistry: UNSRegistry, resolver: Resolver, mintingController: MintingController, mintingManager: MintingManager;
  ...
  it('should persist state after proxy upgrade', async () => {
    ...
    await upgrades.upgradeProxy(mintingManager.address, new MintingManager__factory(coinbase));
