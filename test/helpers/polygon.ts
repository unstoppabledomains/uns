...
export const buildPredicateExitInput = async (withdrawer: string, receiver: string, tokenId: BigNumberish): Promise<string> => {
  /**
...
export const buildPredicateBatchExitInput = async (withdrawer: string, tokenIds: BigNumberish[]) => {
  /**
