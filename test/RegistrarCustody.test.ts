...
describe('RegistrarCustody', () => {
  ...
  describe('tokenizeDomain', () => {
    it('tokenizes new domain', async () => {
      ...
      await expect(tx).to.emit(registrarCustody, 'TokenizedDomain').withArgs(tokenId, registrarId, user.address);
    ...
    it('tokenizes an existing domain owned by an EOA', async () => {
      ...
      await expect(tx).to.emit(registrarCustody, 'TokenizedDomain').withArgs(tokenId, registrarId, otherUser.address);
