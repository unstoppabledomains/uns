...
export interface RootRegistry extends BaseContract {
    connect(runner?: ContractRunner | null): RootRegistry;
    waitForDeployment(): Promise<this>;
    interface: RootRegistryInterface;
