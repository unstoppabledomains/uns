...
export interface UNSRegistryMockInterface extends Interface {
...
export interface UNSRegistryMock extends BaseContract {
    connect(runner?: ContractRunner | null): UNSRegistryMock;
    ...
    getTokenName: TypedContractMethod<[tokenId: BigNumberish], [string], "view">;
    ...
    getFunction(nameOrSignature: "getTokenName"): TypedContractMethod<[tokenId: BigNumberish], [string], "view">;
