...
export interface UNSRegistryForwarderMockInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "execute" | "initialize" | "nonceOf" | "verify"): FunctionFragment;
