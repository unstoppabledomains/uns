...
export interface WorkerSAInterface extends Interface {
...
export interface WorkerSA extends BaseContract {
    connect(runner?: ContractRunner | null): WorkerSA;
    waitForDeployment(): Promise<this>;
    interface: WorkerSAInterface;
...
//# sourceMappingURL=WorkerSA.d.ts.map