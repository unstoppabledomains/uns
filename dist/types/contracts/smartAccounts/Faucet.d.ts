...
export interface FaucetInterface extends Interface {
    getFunction(nameOrSignature: "addAuthorizedWorkers" | "authorizedWorkers" | "fundWorker" | "owner" | "removeAuthorizedWorkers" | "renounceOwnership" | "setWorkerFundingAmount" | "transferOwnership" | "withdraw" | "withdrawAll" | "workerFundingAmount"): FunctionFragment;
