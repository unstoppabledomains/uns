...
export interface UserSmartAccountInterface extends Interface {
    getFunction(nameOrSignature: "SMART_ACCOUNT_TYPEHASH" | "eip712Domain" | "encodeCalls" | "execute((address,uint256,bytes)[])" | "execute((address,uint256,bytes)[],uint256,(uint8,bytes32,bytes32))" | "nonce"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "BatchExecuted" | "CallExecuted" | "EIP712DomainChanged"): EventFragment;
    encodeFunctionData(functionFragment: "SMART_ACCOUNT_TYPEHASH", values?: undefined): string;
    encodeFunctionData(functionFragment: "eip712Domain", values?: undefined): string;
    encodeFunctionData(functionFragment: "encodeCalls", values: [ISmartAccount.CallStruct[]]): string;
    ...
    decodeFunctionResult(functionFragment: "SMART_ACCOUNT_TYPEHASH", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "eip712Domain", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "encodeCalls", data: BytesLike): Result;
...
export interface UserSmartAccount extends BaseContract {
    connect(runner?: ContractRunner | null): UserSmartAccount;
    waitForDeployment(): Promise<this>;
    interface: UserSmartAccountInterface;
    ...
    SMART_ACCOUNT_TYPEHASH: TypedContractMethod<[], [string], "view">;
    ...
    encodeCalls: TypedContractMethod<[
        calls: ISmartAccount.CallStruct[]
    ], [
        string
    ], "view">;
    ...
    getFunction(nameOrSignature: "SMART_ACCOUNT_TYPEHASH"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "encodeCalls"): TypedContractMethod<[calls: ISmartAccount.CallStruct[]], [string], "view">;
...
//# sourceMappingURL=UserSmartAccount.d.ts.map