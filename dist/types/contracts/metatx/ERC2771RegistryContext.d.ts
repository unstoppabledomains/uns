...
export interface ERC2771RegistryContextInterface extends utils.Interface {
    functions: {
...
export interface ERC2771RegistryContext extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC2771RegistryContextInterface;
...
//# sourceMappingURL=ERC2771RegistryContext.d.ts.map