...
export interface ChildRegistryInterface extends Interface {
    getFunction(nameOrSignature: "BATCH_LIMIT" | "approve" | "balanceOf" | "deposit" | "getApproved" | "isApprovedForAll" | "name" | "ownerOf" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "Initialized" | "Transfer"): EventFragment;
...
export interface ChildRegistry extends BaseContract {
    connect(runner?: ContractRunner | null): ChildRegistry;
    waitForDeployment(): Promise<this>;
    interface: ChildRegistryInterface;
