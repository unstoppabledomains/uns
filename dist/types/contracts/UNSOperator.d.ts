...
export interface UNSOperatorInterface extends Interface {
    getFunction(nameOrSignature: "NAME" | "VERSION" | "initialize" | "owner" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
...
export interface UNSOperator extends BaseContract {
    connect(runner?: ContractRunner | null): UNSOperator;
