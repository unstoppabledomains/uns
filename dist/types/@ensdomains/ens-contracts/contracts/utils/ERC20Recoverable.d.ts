...
export interface ERC20RecoverableInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "owner" | "recoverFunds" | "renounceOwnership" | "transferOwnership"): FunctionFragment;
