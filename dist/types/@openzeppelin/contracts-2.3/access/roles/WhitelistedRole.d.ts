...
export interface WhitelistedRoleInterface extends Interface {
    getFunction(nameOrSignature: "addWhitelistAdmin" | "addWhitelisted" | "isWhitelistAdmin" | "isWhitelisted" | "removeWhitelisted" | "renounceWhitelistAdmin" | "renounceWhitelisted"): FunctionFragment;
...
export interface WhitelistedRole extends BaseContract {
    connect(runner?: ContractRunner | null): WhitelistedRole;
