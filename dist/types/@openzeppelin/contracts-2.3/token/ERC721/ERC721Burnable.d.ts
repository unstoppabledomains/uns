...
export interface ERC721BurnableInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "burn" | "getApproved" | "isApprovedForAll" | "ownerOf" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "transferFrom"): FunctionFragment;
