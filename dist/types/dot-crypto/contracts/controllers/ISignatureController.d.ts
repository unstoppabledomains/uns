...
export interface ISignatureControllerInterface extends Interface {
    getFunction(nameOrSignature: "burnChildFor" | "burnFor" | "mintChildFor" | "nonceOf" | "resolveToFor" | "safeTransferFromChildFor(address,address,uint256,string,bytes)" | "safeTransferFromChildFor(address,address,uint256,string,bytes,bytes)" | "safeTransferFromFor(address,address,uint256,bytes,bytes)" | "safeTransferFromFor(address,address,uint256,bytes)" | "transferFromChildFor" | "transferFromFor"): FunctionFragment;
...
export interface ISignatureController extends BaseContract {
    connect(runner?: ContractRunner | null): ISignatureController;
    waitForDeployment(): Promise<this>;
    interface: ISignatureControllerInterface;
...
//# sourceMappingURL=ISignatureController.d.ts.map