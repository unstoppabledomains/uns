...
export interface URIPrefixControllerInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "addWhitelistAdmin" | "addWhitelisted" | "isWhitelistAdmin" | "isWhitelisted" | "registry" | "removeWhitelisted" | "renounceWhitelistAdmin" | "renounceWhitelisted" | "setTokenURIPrefix"): FunctionFragment;
