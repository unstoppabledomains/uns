...
export declare class ERC20Recoverable__factory extends ContractFactory {
    ...
    attach(address: string): ERC20Recoverable;
    connect(signer: Signer): ERC20Recoverable__factory;
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): ERC20Recoverable;
}
export {};
