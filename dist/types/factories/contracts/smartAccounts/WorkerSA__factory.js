...
exports.WorkerSA__factory = void 0;
const ethers_1 = require("ethers");
const _abi = [
    {
        inputs: [
            {
                internalType: "contract IFaucetSA",
                name: "_faucet",
                type: "address",
            },
        ],
...
class WorkerSA__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            super(...args);
        }
...
exports.WorkerSA__factory = WorkerSA__factory;
WorkerSA__factory.bytecode = _bytecode;
WorkerSA__factory.abi = _abi;
