...
import type { IFaucetSA, IFaucetSAInterface } from "../../../contracts/smartAccounts/IFaucetSA";
export declare class IFaucetSA__factory {
    ...
    static createInterface(): IFaucetSAInterface;
    static connect(address: string, runner?: ContractRunner | null): IFaucetSA;
}
//# sourceMappingURL=IFaucetSA__factory.d.ts.map