...
import type { WorkerSA, WorkerSAInterface } from "../../../contracts/smartAccounts/WorkerSA";
declare type WorkerSAConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
export declare class WorkerSA__factory extends ContractFactory {
    constructor(...args: WorkerSAConstructorParams);
    ...
    connect(runner: ContractRunner | null): WorkerSA__factory;
    ...
    static readonly abi: readonly [{
        readonly inputs: readonly [{
            readonly internalType: "contract IFaucetSA";
    ...
    static createInterface(): WorkerSAInterface;
    static connect(address: string, runner?: ContractRunner | null): WorkerSA;
}
export {};
//# sourceMappingURL=WorkerSA__factory.d.ts.map